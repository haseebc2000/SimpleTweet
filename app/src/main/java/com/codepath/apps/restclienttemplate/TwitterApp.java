 ...
 *
 *     CanaryClient client = CanaryApp.getRestClient(Context context);
...
public class CanaryApp extends Application {
    ...
    public static CanaryClient getRestClient(Context context) {
        return (CanaryClient) CanaryClient.getInstance(CanaryClient.class, context);
    }
